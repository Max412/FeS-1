...
def update():
 FeS_Version = urllib.request.urlopen('https://raw.githubusercontent.com/Max412/FeS/main/Version.txt').read().decode('utf8').splitlines()[0]
 #FeS_Version2 = urllib.request.urlopen('https://raw.githubusercontent.com/Max412/FeS/main/Version2.txt').read().decode('utf8').splitlines()[0]
 ...
 FeS_Link = 'https://github.com/FeSprog/FeS/archive/refs/heads/main.zip'
 FeS_Path = 'main.zip'


 if FeS_Version == os.path.basename(__file__):
  ctypes.windll.user32.MessageBoxW(None, u"Установлена актуальная версия программы!", u"Обновление")
 else:
  ctypes.windll.user32.MessageBoxW(None, u"Начат процесс обновления!", u"Обновление")

  urllib.request.urlretrieve(FeS_Link, FeS_Path)
  #print('Распаковываем архив...')
  shutil.unpack_archive(FeS_Path, 'Updated')
  os.remove(FeS_Path)
...
def connect():
 ...
 rb1 = Radiobutton(root, text='⭐', font='20', variable=var, value=1, command=check)
 rb2 = Radiobutton(root, text='⭐⭐', font='20', variable=var, value=2, command=check)
 rb3 = Radiobutton(root, text='⭐⭐⭐', font='20', variable=var, value=3, command=check)
 ...
 rb1 = Radiobutton(root, text='⭐', font='20', variable=var1, value=1, command=check1)
 rb2 = Radiobutton(root, text='⭐⭐', font='20', variable=var1, value=2, command=check1)
 rb3 = Radiobutton(root, text='⭐⭐⭐', font='20', variable=var1, value=3, command=check1)


 rb1.place(x=10, y= 120)
 rb2.place(x=10, y= 145)
 rb3.place(x=10, y= 170)

 var2 = IntVar()
 #var2.set(3)

 rb1 = Radiobutton(root, text='⭐', font='20', variable=var2, value=1, command=check2)
 rb2 = Radiobutton(root, text='⭐⭐', font='20', variable=var2, value=2, command=check2)
 rb3 = Radiobutton(root, text='⭐⭐⭐', font='20', variable=var2, value=3, command=check2)


 rb1.place(x=10, y= 220)
 rb2.place(x=10, y= 245)
 rb3.place(x=10, y= 270)
...
btn2 = Button(window, text="Дешифровать!", command=decrypt)
...
btn7 = Button(window, text="Обновить", command=update)
...
btn7.place(relx = .67, rely = .5, relwidth=.1, relheight=.06)
